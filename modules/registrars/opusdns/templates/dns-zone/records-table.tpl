    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div class="d-flex align-items-center">
            <div class="btn-group btn-group-sm" role="group">
                <button type="button" class="btn btn-primary" x-show="selectedRecords.length === 0" x-on:click="openRrsetAddModal()" :disabled="loading">
                    <i class="far fa-plus fa-sm mr-1"></i> {$LANG.opusdns.dns_zone.modals.record.actions.add}
                </button>
                <button type="button" class="btn btn-danger rounded-left" x-show="selectedRecords.length > 0" x-on:click="confirmDeleteRrsets()" :disabled="loading">
                ...
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" :disabled="loading">
    ...
    <div class="position-relative">
        ...
        <div class="table-responsive border rounded">
            <table class="table dns-table my-0 py-0">
                ...
                <tbody>
                    {include file="modules/registrars/opusdns/templates/dns-zone/partials/records-table-soa-row.tpl"}
