<tr>
    ...
    <td class="row-value">
        <template x-for="rec in record.records" :key="rec.rdata">
            <span class="d-block fs-14" x-text="rec.rdata"></span>
        </template>
    </td>
    <td class="row-actions position-sticky" style="right: 0;">
        <div class="btn-group btn-group-sm">
            <button type="button" class="btn btn-outline-secondary btn-sm" x-on:click="openRrsetUpdateModal(record)" title="{$LANG.opusdns.dns_zone.actions.edit}">
